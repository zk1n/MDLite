...
| QA-04 | table parser、可視行横断の共有column geometry、描画とmouse/caret hit-testの共通経路、`table-hit-test-native-responsive-final9.json` 4/4、`table-edit-native-final10.json` の行列操作・Undo/Redo・Tab・矢印 10/11 | Shift+Tab実native入力（SendInput Win32 87）と実DPIのcell hit-test/操作感は未実施 |
